...
UGA_PMNeutralSpecial::UGA_PMNeutralSpecial()
{
...
void UGA_PMNeutralSpecial::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	PlayComboMotage->OnBlendOut.AddDynamic(this, &UGA_PMNeutralSpecial::K2_EndAbility);
	PlayComboMotage->OnInterrupted.AddDynamic(this, &UGA_PMNeutralSpecial::K2_EndAbility);
	PlayComboMotage->OnCancelled.AddDynamic(this, &UGA_PMNeutralSpecial::K2_EndAbility);
	PlayComboMotage->OnCompleted.AddDynamic(this, &UGA_PMNeutralSpecial::K2_EndAbility);
	...
	WaitTargetAquiredEvent->EventReceived.AddDynamic(this, &UGA_PMNeutralSpecial::HandleDamage);
	...
	WaitForActivation->EventReceived.AddDynamic(this, &UGA_PMNeutralSpecial::TryCommitSpecial);

	WaitForActivation->ReadyForActivation();
}

void UGA_PMNeutralSpecial::HandleDamage(FGameplayEventData Payload)
{
...
void UGA_PMNeutralSpecial::TryCommitSpecial(FGameplayEventData Payload)
{
...
void UGA_PMNeutralSpecial::AbilityInputPressed(float TimeWaited)
{
	SetupWaitInputTask();
	TryCommitSpecial(FGameplayEventData());
}

void UGA_PMNeutralSpecial::SetupWaitInputTask()
{
	UAbilityTask_WaitInputPress* WaitInputPress = UAbilityTask_WaitInputPress::WaitInputPress(this);
	WaitInputPress->OnPress.AddDynamic(this, &UGA_PMNeutralSpecial::AbilityInputPressed);
