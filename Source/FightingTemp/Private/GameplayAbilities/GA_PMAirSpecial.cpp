...
UGA_PMAirSpecial::UGA_PMAirSpecial()
{
...
void UGA_PMAirSpecial::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	PlayComboMotage->OnBlendOut.AddDynamic(this, &UGA_PMAirSpecial::K2_EndAbility);
	PlayComboMotage->OnInterrupted.AddDynamic(this, &UGA_PMAirSpecial::K2_EndAbility);
	PlayComboMotage->OnCancelled.AddDynamic(this, &UGA_PMAirSpecial::K2_EndAbility);
	PlayComboMotage->OnCompleted.AddDynamic(this, &UGA_PMAirSpecial::K2_EndAbility);
	...
	WaitTargetAquiredEvent->EventReceived.AddDynamic(this, &UGA_PMAirSpecial::HandleDamage);
	...
	WaitForActivation->EventReceived.AddDynamic(this, &UGA_PMAirSpecial::TryCommitSpecial);

	WaitForActivation->ReadyForActivation();
}

void UGA_PMAirSpecial::HandleDamage(FGameplayEventData Payload)
{
...
void UGA_PMAirSpecial::TryCommitSpecial(FGameplayEventData Payload)
{
...
void UGA_PMAirSpecial::AbilityInputPressed(float TimeWaited)
{
	SetupWaitInputTask();
	TryCommitSpecial(FGameplayEventData());
}

void UGA_PMAirSpecial::SetupWaitInputTask()
{
	UAbilityTask_WaitInputPress* WaitInputPress = UAbilityTask_WaitInputPress::WaitInputPress(this);
	WaitInputPress->OnPress.AddDynamic(this, &UGA_PMAirSpecial::AbilityInputPressed);
