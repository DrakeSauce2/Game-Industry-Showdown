...
UGA_PMLowSpecial::UGA_PMLowSpecial()
{
...
void UGA_PMLowSpecial::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	PlayComboMotage->OnBlendOut.AddDynamic(this, &UGA_PMLowSpecial::K2_EndAbility);
	PlayComboMotage->OnInterrupted.AddDynamic(this, &UGA_PMLowSpecial::K2_EndAbility);
	PlayComboMotage->OnCancelled.AddDynamic(this, &UGA_PMLowSpecial::K2_EndAbility);
	PlayComboMotage->OnCompleted.AddDynamic(this, &UGA_PMLowSpecial::K2_EndAbility);
	...
	WaitTargetAquiredEvent->EventReceived.AddDynamic(this, &UGA_PMLowSpecial::HandleDamage);
	...
	WaitForActivation->EventReceived.AddDynamic(this, &UGA_PMLowSpecial::TryCommitSpecial);

	WaitForActivation->ReadyForActivation();
}

void UGA_PMLowSpecial::HandleDamage(FGameplayEventData Payload)
{
...
void UGA_PMLowSpecial::TryCommitSpecial(FGameplayEventData Payload)
{
...
void UGA_PMLowSpecial::AbilityInputPressed(float TimeWaited)
{
	SetupWaitInputTask();
	TryCommitSpecial(FGameplayEventData());
}

void UGA_PMLowSpecial::SetupWaitInputTask()
{
	UAbilityTask_WaitInputPress* WaitInputPress = UAbilityTask_WaitInputPress::WaitInputPress(this);
	WaitInputPress->OnPress.AddDynamic(this, &UGA_PMLowSpecial::AbilityInputPressed);
